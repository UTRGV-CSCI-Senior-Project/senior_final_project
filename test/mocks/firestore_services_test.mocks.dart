...
// in folio/test/unit/services/firestore_services_test.dart.
...
class MockRef<State extends Object?> extends _i1.Mock
  ...
  @override
  _i6.ProviderContainer get container => (super.noSuchMethod(
  ...
  @override
  T refresh<T>(_i6.Refreshable<T>? provider) => (super.noSuchMethod(
        Invocation.method(
          #refresh,
          [provider],
        ),
  ...
  @override
  T read<T>(_i6.ProviderListenable<T>? provider) => (super.noSuchMethod(
        Invocation.method(
          #read,
          [provider],
        ),
  ...
  @override
  bool exists(_i6.ProviderBase<Object?>? provider) => (super.noSuchMethod(
        Invocation.method(
          #exists,
          [provider],
        ),

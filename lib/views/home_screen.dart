...
import 'package:folio/views/tabs/profile_tab.dart';
...
class HomeScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final portfolioData = ref.watch(portfoliosProvider);
          ...
          if (userModel.completedOnboarding) {
            ...
            return Scaffold(
              ...
              body: IndexedStack(
                index: selectedIndex,
                children: [
                  HomeTab(userModel: userModel, portfolioData: portfolioData),
                  DiscoverTab(userModel: userModel),
                  ProfileTab(userModel: userModel),
                  ProfileTab(userModel: userModel)
                ],
              ),
